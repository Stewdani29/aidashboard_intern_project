        ...
        <div key={space.heading} className="block bg-white p-4 rounded-lg shadow hover:shadow-md transition">
            <Dialog.Root >
                <Dialog.Trigger asChild>
                    <img src={LANGUAGE_VERSIONS[space.language]?.banner || "https://via.placeholder.com/50"} alt={space.language} className="w-full h-32 cursor-pointer shadow-md rounded-lg mb-3 active:scale-95 transition-all" />
                </Dialog.Trigger>
                <Dialog.Portal>
                        ...
                        <div className="flex flex-col md:flex-row gap-6">
                            ...
                            <div className="flex-1 flex flex-col">
                                ...
                                <div className="flex items-center justify-start gap-3">
                                    ...
                                    <h2 className="text-sm rounded-md px-3 py-1 uppercase bg-black text-white">{space.language}</h2>
                                </div>
            ...
            <div className="container mx-auto">
                ...
                {spacestemplates.length < 1 && <div className="flex flex-col items-center justify-center h-[70vh]">
                    <img
                        ...
                        className="w-32 mb-6"
                    />
                    <h2 className="text-xl font-medium text-gray-600">No CodeTemplates are available</h2>
