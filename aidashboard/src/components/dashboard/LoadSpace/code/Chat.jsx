    ...
    return (
        <div className='flex w-full h-[90%] gap-3 px-3 pb-5' >
            <div className="h-full w-full bg-white rounded-md text-main">
                <div className={`w-full ${conversation.length == 0 ? 'flex flex-col items-center justify-center' : ''} h-[90%] px-3 pt-2 Sara-cont overflow-y-auto`}>
                                    ...
                                    <div className="message-container">
                                        <div className="flex items-center justify-between pb-3">
                                            <span className="inline-flex items-center justify-center gap-2">
                                                ...
                                                />
                                                <h1 className="text-base hidden md:block font-semibold text-main">Sara AI</h1>
                                            </span>
